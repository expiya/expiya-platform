...
export const metadata: Metadata = {
  ...
  alternates: { canonical: "/cars/satis-danismani-bilgilendirmesi" },
};
...
export default function SalesAdvisorDisclosurePage() {
  return <main className="min-h-screen bg-white px-5 py-12 text-neutral-950 sm:px-8">
    <article className="mx-auto max-w-3xl rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900 sm:p-10">
      <Link href="/cars" className="text-sm font-semibold underline underline-offset-4">← Karar görüşmesine dön</Link>
