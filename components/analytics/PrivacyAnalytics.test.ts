...
describe("analytics URL privacy", () => {
  it("removes query strings, fragments and dynamic identifiers", () => {
    ...
    expect(sanitizeAnalyticsEvent({ type: "event", url: "https://www.expiya.com/decision/internal-id?token=secret" })).toEqual({ type: "event", url: "https://www.expiya.com/decision/[id]" });
  });
