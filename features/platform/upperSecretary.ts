...
export function classifySecretaryMessage(rawMessage: string, context: SecretarySessionContext = {}): SecretaryOutcome {
  ...
  if (containsPhrase(message, "hangi bölümler") || containsPhrase(message, "aktif bölümler")) return { kind: "FAQ_RESPONSE", message: "Şu anda Otomobil, Ev Ürünleri ve Elektronik bölümleri aktiftir." };
