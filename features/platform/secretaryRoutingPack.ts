...
export type ActiveSecretaryDepartmentId = "CARS" | "APPLIANCES" | "ELECTRONICS";
export interface SecretaryRouteDescriptor { readonly departmentId: ActiveSecretaryDepartmentId; readonly localizedLabel: string; readonly categoryId?: AppliancesProductType | ElectronicsCategoryId; readonly aliases: readonly string[]; readonly destination: string }
...
export const SECRETARY_NEGATIVE_COMPOUNDS = Object.freeze(["bebek arabası", "bebek arabasi", "oyuncak araba", "araba koltuğu", "araba koltugu", "bebek oto koltuğu", "bebek oto koltugu", "arabalı yatak", "arabali yatak"] as const);
