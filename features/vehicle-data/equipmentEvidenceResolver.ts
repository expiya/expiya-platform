...
export function loadActiveEquipmentEvidenceStatus() {
  if (reviewedCandidate) return Object.freeze({
    ...
    uncoveredExactVariantCount: reviewedCandidate.coverage?.uncoveredCoverage?.exactVariantCount ?? 562,
    totalCatalogVariantCount: reviewedCandidate.coverage?.catalogVariantCount ?? 566, availabilityProjectionCount: reviewedCandidate.projections.length,
