...
import activeCatalogManifest from "@/data/production/catalog/releases/v0.3.0/manifest.json";
...
describe("Hyundai catalog expansion release v0.3.0", () => {
  ...
  it("is selected by the active production pointer", () => {
    ...
    expect(resolveRecommendationCatalog("production", new Date("2026-08-16T13:00:00.000Z")).cars).toHaveLength(52);
  });
});
