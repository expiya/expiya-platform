...
import activeCatalogManifest from "@/data/production/catalog/releases/v0.54.0/manifest.json";
...
describe("Hyundai catalog expansion release v0.3.0", () => {
  ...
  it("remains present after the active catalog advances to the Citroën commercial release", () => {
    ...
    expect(resolveRecommendationCatalog("production", new Date("2026-09-01T01:00:00.000Z")).cars).toHaveLength(513);
  });
});
