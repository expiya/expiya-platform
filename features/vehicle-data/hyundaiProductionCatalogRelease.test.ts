...
import activeCatalogManifest from "@/data/production/catalog/releases/v0.6.0/manifest.json";
...
describe("Hyundai catalog expansion release v0.3.0", () => {
  ...
  it("remains present after the active catalog advances to the Alpine release", () => {
    ...
    expect(resolveRecommendationCatalog("production", new Date("2026-08-16T23:00:00.000Z")).cars).toHaveLength(63);
  });
});
