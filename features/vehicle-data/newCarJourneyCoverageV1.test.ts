...
import mapping from "@/data/runtime/vehicle-candidate-identity-maps/v0.3.0/mapping.json";
...
describe("new-car journey coverage v1 audit", () => {
  ...
  it("authorizes exact Clio and at least two compact alternatives", () => {
    expect(journeyCoverageV1ActivatedCandidateIds).toContain("1eb75421-a038-4679-977e-7cd4e4608863");
    expect(journeyCoverageV1ActivatedCandidateIds).toContain("01a559dd-917f-4f49-a4cf-84fe78e9de40");
    expect(journeyCoverageV1ActivatedCandidateIds).toContain("c8d535d0-6c04-4dcb-8cf6-2bad5bd037e8");
  });
