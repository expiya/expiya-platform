...
export const MOBILITY_VISUAL_PACK = Object.freeze({ experienceVersion: XPY_EXPERIENCE_VERSION, visualPackId: "mobility-visual/v1", domainPackId: "mobility/v1", publicName: "Expiya Mobilite", sceneConcept: "NEUTRAL", tokens: sharedTokens, labels: { stageOne: "Aşama 1 · Karar görüşmesi", stageTwo: "Aşama 2 · Ürün değerlendirmesi", stageThree: "Aşama 3 · Güvenli talep", composerPlaceholder: "İhtiyacını anlat…" }, assets: [], slots: sharedSlots } satisfies XpyDomainVisualPack);
...
export const MOBILITY_EXPERIENCE = defineXpyExperienceAdapter({ experienceVersion: XPY_EXPERIENCE_VERSION, departmentId: "MOBILITY", visualPack: MOBILITY_VISUAL_PACK, stages: [
  { id: "STAGE_1_DECISION", label: "Aşama 1 · Karar", href: "/mobility#asama-1", availability: "AVAILABLE" },
  { id: "STAGE_2_EVALUATION", label: "Aşama 2 · Değerlendir", href: "/mobility/stage/2", availability: "REQUIRES_HANDOFF", unavailableReason: "Önce Aşama 1'de yetkili bir ürün kararı gerekir." },
  { id: "STAGE_3_ACTION", label: "Aşama 3 · Talep", href: "/mobility/stage/3", availability: "UNAVAILABLE", unavailableReason: "Satış, teklif, sipariş ve ödeme işlemleri açık değil." },
] });
