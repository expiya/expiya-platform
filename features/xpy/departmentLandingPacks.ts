import { APPLIANCES_VISUAL_PACK, BABY_VISUAL_PACK, CARS_VISUAL_PACK, ELECTRONICS_VISUAL_PACK, MOBILITY_VISUAL_PACK } from "./visualPacks";
...
export const MOBILITY_LANDING_PACK=defineDepartmentLandingPack({version:XPY_DEPARTMENT_LANDING_VERSION,departmentId:"MOBILITY",canonicalPath:"/mobility",visualPack:MOBILITY_VISUAL_PACK,eyebrow:"Mobilite seçim asistanı",headline:["Doğru hareket çözümünü","birlikte bulalım"],supportingCopy:"Elektrikli scooter, elektrikli bisiklet ve bisiklet ihtiyaçlarınızı Türkiye için doğrulanmış ürünlerle konuşun.",primaryCta:{label:"Görüşmeye başla",href:"/mobility#asama-1"},secondaryCta:{label:"Expiya nedir?",href:"/expiya-nedir"},categories:[{id:"ELECTRIC_SCOOTER",label:"Elektrikli scooter",description:"Şehir kullanımı, taşıma, menzil ve güvenlik sınırları.",href:"/mobility?category=ELECTRIC_SCOOTER#asama-1",availability:"AVAILABLE"},{id:"ELECTRIC_BICYCLE",label:"Elektrikli bisiklet",description:"Motor, batarya, beden ve kullanım zemini.",href:"/mobility?category=ELECTRIC_BICYCLE#asama-1",availability:"AVAILABLE"},{id:"BICYCLE",label:"Bisiklet",description:"Şehir, tur, katlanır ve dağ kullanımı ile beden uyumu.",href:"/mobility?category=BICYCLE#asama-1",availability:"AVAILABLE"}],works:[{title:"İhtiyacınızı anlar",description:"Tek seferde tek günlük soruyla kullanımınızı netleştirir."},{title:"Kanıtı korur",description:"Menzili garantiye dönüştürmez; bilinmeyeni tahmin etmez."},{title:"Kararı açıklar",description:"Uyumluluk ve Pareto sınırında bağlı seçenekleri dürüstçe gösterir."}],xpy,stages:[{id:"STAGE_1_DECISION",label:"AŞAMA 1 · Karar görüşmesi",description:"Üç aktif mobilite kategorisinde karar görüşmesi.",href:"/mobility#asama-1",availability:"AVAILABLE"},{id:"STAGE_2_EVALUATION",label:"AŞAMA 2 · Ürün değerlendirmesi",description:"Yalnız yetkili AŞAMA 1 kararından açılır.",href:"/mobility/stage/2",availability:"REQUIRES_HANDOFF"},{id:"STAGE_3_ACTION",label:"AŞAMA 3 · Güvenli talep",description:"Satış, teklif ve sipariş açık değil.",href:"/mobility/stage/3",availability:"UNAVAILABLE"}],trust:{title:"Teknik gerçek ile ticareti ayırır",description:"Amazon ve perakendeci kayıtları keşif/fiyat içindir; teknik gerçek üretici kanıtından gelir.",points:["Exact Türkiye kimliği","Bilinmeyenler açık","Fiyat ve popülerlik sıralama dışı"]},footerCopy:"Expiya Mobilite, kişisel hareket ürünlerini kanıt sınırlarıyla değerlendirir."});
export const DEPARTMENT_LANDING_PACKS = Object.freeze({ CARS: CARS_LANDING_PACK, APPLIANCES: APPLIANCES_LANDING_PACK, ELECTRONICS: ELECTRONICS_LANDING_PACK, BABY_AND_CHILD: BABY_LANDING_PACK, MOBILITY: MOBILITY_LANDING_PACK });
