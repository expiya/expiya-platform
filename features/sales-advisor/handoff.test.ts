...
describe("signed phase 2 handoff", () => {
  ...
  it("shows only latest positive hard filters in the Phase 2 fit section", () => {
    ...
    expect(approvedNeedsForPhase2(state)).toEqual([{ concept: "modelPreference", summary: "Model tercihi: Jogger", value: "Jogger" }]);
  });
