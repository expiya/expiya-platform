...
export interface PlatformIntegrationManifest { readonly status: "PENDING_OWNER_APPROVAL"; readonly consumers: readonly ["EXPİYA_NEDİR", "SECRETARY_IDENTITY_ROUTING", "UNIVERSAL_CARDS"]; readonly registryMutation: "FORBIDDEN"; readonly categoryDigests: Readonly<Record<string, string>> }
