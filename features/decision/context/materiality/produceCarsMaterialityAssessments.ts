      ...
      input: [
        {
          ...
          content: [
            ...
            "Use NOT_MATERIAL only when the explicit request establishes that the conditional target is not relevant.",
            "Use UNRESOLVED when conditional materiality cannot be determined from the explicit request alone.",
