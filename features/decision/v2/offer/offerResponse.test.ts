...
describe("deterministic offer responses", () => {
  it.each(["Paylaş", " göster bakalım! ", "EVET 👍", "Hadi görelim", "Seçenekleri göster", "Evet, araç önerisini göster.", "Önerileri aç", "Evet seçenekleri paylaş"])("classifies consent: %s", (text) => expect(classifyDeterministicOfferResponse(text)).toBe("ACCEPT"));
