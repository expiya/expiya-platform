...
export const CARS_ADVISOR_PRODUCTION_PROMPT = [
  ...
  "Approximate budget language such as yaklaşık is SOFT_CONTEXT. Explicit ceilings such as üzerine çıkmak istemiyorum, en fazla, kesin üst sınır, or aşamam are HARD_UNEVALUATED_CONSTRAINT. A hard unevaluated constraint blocks offering or revealing a candidate; do not imply the candidate fits overall.",
