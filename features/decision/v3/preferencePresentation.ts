...
const PUBLIC_VALUES: Readonly<Record<string, string>> = Object.freeze({
  ...
  NOT_IMPORTANT: "bu başlık karar için önemli değil", MINIMAL: "başka bir donanım zorunlu değil", ADVISOR_GUIDANCE: "yakıt türü filtrelenmeden danışman değerlendirmesi", USER_SELECTED: "kullanıcı tarafından seçildi", AUTOMATIC: "otomatik", MANUAL: "manuel",
