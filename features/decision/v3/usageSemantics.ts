...
export function detectExplicitUsagePurpose(text: string): DetectedUsagePurpose | undefined {
  ...
  const patterns: readonly [RegExp, V3UsagePurpose][] = [
    ...
    [/(?:kamp|arazi|bozuk yol|köy yol|yayla|bağ evi|çiftlik yol|patika|doğa(?:ya|da)|4x4|dört çeker)|(?:bisiklet|kamp|açık hava|outdoor|spor).{0,50}(?:malzeme|ekipman)/iu, "MIXED_ROAD"],
